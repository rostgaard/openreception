...
/// Event that notifies about a call being being transferred.
class CallTransfer extends CallEvent {
  @override
  final String eventName = _Key._callTransfer;

  /// Default constructor. Subtypes the general [CallEvent] class and should
  /// be used to notify clients about a call being transferred.
  CallTransfer(model.Call call) : super(call);

  /// Create a [CallTransfer] object from serialized data stored in [map].
