...
String parameterToString(dynamic value) {
  ...
  } else if (value is CallState) {
    return CallStateTypeTransformer().encode(value).toString();
  } else if (value is ChangeType) {
    return ChangeTypeTypeTransformer().encode(value).toString();
  } else if (value is MessageEndpointType) {
    return MessageEndpointTypeTypeTransformer().encode(value).toString();
  } else if (value is MessageState) {
    return MessageStateTypeTransformer().encode(value).toString();
  } else if (value is ObjectType) {
    return ObjectTypeTypeTransformer().encode(value).toString();
  } else if (value is ResponseCode) {
    return ResponseCodeTypeTransformer().encode(value).toString();
  } else {
