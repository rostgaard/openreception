...
/**
 * Provides methods for manipulating the reception type UI widget.
 */
class UIReceptionType extends UIModel {
  final DivElement _myRoot;

  /**
   * Constructor.
   */
  UIReceptionType(DivElement this._myRoot) {
    _setupLocalKeys();
    _observers();
  }
  ...
  /**
   * Add [items] to the reception type list.
   */
  set type(List<String> items) {
